...
public class Weapon : Item
{
    ...
    [SerializeField] List<Skill> weaponSkills;
    ...
    public List<Skill> GetWeaponSkills() { return weaponSkills; }
    public Skill GetRandomSkill() { return (weaponSkills.Count > 1) ? weaponSkills[Random.Range(0, weaponSkills.Count)] : weaponSkills[0]; }
