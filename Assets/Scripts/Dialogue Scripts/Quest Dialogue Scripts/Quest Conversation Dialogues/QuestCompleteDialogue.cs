...
[CreateAssetMenu(fileName = "New Quest Status Dialogue", menuName = "Dialogues/Quest Dialogues/Quest Status/Complete", order = 3)]
public class QuestCompleteDialogue : QuestStatusDialogue, IPlayerDialogue, INPCDialogue, IRespondable
{

    protected QuestCompleteDialogue() : base(QuestStatusType.complete) { }
